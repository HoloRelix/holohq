...
const SEARCH_CARDS = [
  // ── Base Set ─────────────────────────────────────────────────────────
  { id:"base1-4",   name:"Charizard",         variant:null,   finish:null,                        set:"Base Set",                    setId:"base1",     number:"4",    year:"1999", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/base1/4_hires.png" },
  { id:"base1-4-1", name:"Charizard",         variant:null,   finish:null,                        set:"Base Set 1st Edition",        setId:"base1",     number:"4",    year:"1999", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/base1/4_hires.png" },
  { id:"base1-2",   name:"Blastoise",         variant:null,   finish:null,                        set:"Base Set",                    setId:"base1",     number:"2",    year:"1999", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/base1/2_hires.png" },
  { id:"base1-15",  name:"Venusaur",          variant:null,   finish:null,                        set:"Base Set",                    setId:"base1",     number:"15",   year:"1999", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/base1/15_hires.png" },
  { id:"base1-1",   name:"Alakazam",          variant:null,   finish:null,                        set:"Base Set",                    setId:"base1",     number:"1",    year:"1999", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/base1/1_hires.png" },
  { id:"base1-10",  name:"Mewtwo",            variant:null,   finish:null,                        set:"Base Set",                    setId:"base1",     number:"10",   year:"1999", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/base1/10_hires.png" },
  { id:"base1-14",  name:"Raichu",            variant:null,   finish:null,                        set:"Base Set",                    setId:"base1",     number:"14",   year:"1999", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/base1/14_hires.png" },
  { id:"base1-5",   name:"Clefairy",          variant:null,   finish:null,                        set:"Base Set",                    setId:"base1",     number:"5",    year:"1999", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/base1/5_hires.png" },
  { id:"base1-11",  name:"Nidoking",          variant:null,   finish:null,                        set:"Base Set",                    setId:"base1",     number:"11",   year:"1999", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/base1/11_hires.png" },
  { id:"base1-58",  name:"Pikachu",           variant:null,   finish:null,                        set:"Base Set",                    setId:"base1",     number:"58",   year:"1999", category:"pokemon", rarity:"Common",                       image:"https://images.pokemontcg.io/base1/58_hires.png" },
  // ── Neo Genesis / Revelation ─────────────────────────────────────────
  { id:"neo1-9",    name:"Lugia",             variant:null,   finish:null,                        set:"Neo Genesis",                 setId:"neo1",      number:"9",    year:"2000", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/neo1/9_hires.png" },
  { id:"neo1-12",   name:"Pichu",             variant:null,   finish:null,                        set:"Neo Genesis",                 setId:"neo1",      number:"12",   year:"2000", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/neo1/12_hires.png" },
  { id:"neo1-17",   name:"Typhlosion",        variant:null,   finish:null,                        set:"Neo Genesis",                 setId:"neo1",      number:"17",   year:"2000", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/neo1/17_hires.png" },
  { id:"neo3-7",    name:"Ho-Oh",             variant:null,   finish:null,                        set:"Neo Revelation",              setId:"neo3",      number:"7",    year:"2001", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/neo3/7_hires.png" },
  { id:"neo3-9",    name:"Raikou",            variant:null,   finish:null,                        set:"Neo Revelation",              setId:"neo3",      number:"9",    year:"2001", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/neo3/9_hires.png" },
  // ── Vintage ──────────────────────────────────────────────────────────
  { id:"ecard3-146",name:"Charizard",         variant:null,   finish:null,                        set:"Skyridge",                    setId:"ecard3",    number:"146",  year:"2003", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/ecard3/146_hires.png" },
  { id:"ex15-100",  name:"Charizard",         variant:"Star", finish:null,                        set:"EX Dragon Frontiers",         setId:"ex15",      number:"100",  year:"2006", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/ex15/100_hires.png" },
  { id:"dp1-6",     name:"Lucario",           variant:null,   finish:null,                        set:"Diamond & Pearl",             setId:"dp1",       number:"6",    year:"2007", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/dp1/6_hires.png" },
  { id:"hgss1-113", name:"Lugia",             variant:"Legend",finish:null,                       set:"HeartGold SoulSilver",        setId:"hgss1",     number:"113",  year:"2010", category:"pokemon", rarity:"Ultra Rare",                   image:"https://images.pokemontcg.io/hgss1/113_hires.png" },
  { id:"hgss1-111", name:"Ho-Oh",             variant:"Legend",finish:null,                       set:"HeartGold SoulSilver",        setId:"hgss1",     number:"111",  year:"2010", category:"pokemon", rarity:"Ultra Rare",                   image:"https://images.pokemontcg.io/hgss1/111_hires.png" },
  { id:"bw1-114",   name:"Zekrom",            variant:null,   finish:null,                        set:"Black & White",               setId:"bw1",       number:"114",  year:"2011", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/bw1/114_hires.png" },
  { id:"bw1-113",   name:"Reshiram",          variant:null,   finish:null,                        set:"Black & White",               setId:"bw1",       number:"113",  year:"2011", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/bw1/113_hires.png" },
  { id:"bw8-136",   name:"Charizard",         variant:null,   finish:null,                        set:"Plasma Storm",                setId:"bw8",       number:"136",  year:"2013", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/bw8/136_hires.png" },
  { id:"xy12-11",   name:"Charizard",         variant:null,   finish:null,                        set:"XY Evolutions",               setId:"xy12",      number:"11",   year:"2016", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/xy12/11_hires.png" },
  { id:"xy12-51",   name:"Mewtwo",            variant:null,   finish:null,                        set:"XY Evolutions",               setId:"xy12",      number:"51",   year:"2016", category:"pokemon", rarity:"Rare Holo",                    image:"https://images.pokemontcg.io/xy12/51_hires.png" },
  // ── Hidden Fates ─────────────────────────────────────────────────────
  { id:"sma-SV49",  name:"Charizard",         variant:"GX",   finish:"Shiny",                     set:"Hidden Fates: Shiny Vault",   setId:"sma",       number:"SV49", year:"2019", category:"pokemon", rarity:"Shiny Secret Rare",            image:"https://images.pokemontcg.io/sma/SV49_hires.png" },
  { id:"sma-SV26",  name:"Gyarados",          variant:"GX",   finish:"Shiny",                     set:"Hidden Fates: Shiny Vault",   setId:"sma",       number:"SV26", year:"2019", category:"pokemon", rarity:"Shiny Secret Rare",            image:"https://images.pokemontcg.io/sma/SV26_hires.png" },
  { id:"sma-SV58",  name:"Mewtwo",            variant:"GX",   finish:"Shiny",                     set:"Hidden Fates: Shiny Vault",   setId:"sma",       number:"SV58", year:"2019", category:"pokemon", rarity:"Shiny Secret Rare",            image:"https://images.pokemontcg.io/sma/SV58_hires.png" },
  // ── Sword & Shield ───────────────────────────────────────────────────
  { id:"swsh4-188", name:"Pikachu",           variant:"VMAX", finish:"Rainbow Rare",              set:"Vivid Voltage",               setId:"swsh4",     number:"188",  year:"2020", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh4/188_hires.png" },
  { id:"swsh4-170", name:"Pikachu",           variant:"V",    finish:null,                        set:"Vivid Voltage",               setId:"swsh4",     number:"170",  year:"2020", category:"pokemon", rarity:"Ultra Rare",                   image:"https://images.pokemontcg.io/swsh4/170_hires.png" },
  { id:"cpa-74",    name:"Charizard",         variant:"VMAX", finish:"Rainbow Rare",              set:"Champion's Path",             setId:"cpa",       number:"74",   year:"2020", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/cpa/74_hires.png" },
  { id:"cpa-79",    name:"Charizard",         variant:"V",    finish:"Alt Art",                   set:"Champion's Path",             setId:"cpa",       number:"79",   year:"2020", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/cpa/79_hires.png" },
  { id:"swsh5-168", name:"Single Strike Urshifu",variant:"VMAX",finish:null,                     set:"Battle Styles",               setId:"swsh5",     number:"168",  year:"2021", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh5/168_hires.png" },
  { id:"swsh5-170", name:"Rapid Strike Urshifu",variant:"VMAX",finish:null,                      set:"Battle Styles",               setId:"swsh5",     number:"170",  year:"2021", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh5/170_hires.png" },
  { id:"swsh6-200", name:"Shadow Rider Calyrex",variant:"VMAX",finish:null,                      set:"Chilling Reign",              setId:"swsh6",     number:"200",  year:"2021", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh6/200_hires.png" },
  { id:"swsh6-202", name:"Ice Rider Calyrex",  variant:"VMAX", finish:null,                      set:"Chilling Reign",              setId:"swsh6",     number:"202",  year:"2021", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh6/202_hires.png" },
  // ── Evolving Skies ────────────────────────────────────────────────────
  { id:"swsh7-215", name:"Umbreon",           variant:"VMAX", finish:"Alt Art",                   set:"Evolving Skies",              setId:"swsh7",     number:"215",  year:"2021", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh7/215_hires.png" },
  { id:"swsh7-218", name:"Rayquaza",          variant:"VMAX", finish:"Alt Art",                   set:"Evolving Skies",              setId:"swsh7",     number:"218",  year:"2021", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh7/218_hires.png" },
  { id:"swsh7-203", name:"Sylveon",           variant:"VMAX", finish:"Alt Art",                   set:"Evolving Skies",              setId:"swsh7",     number:"203",  year:"2021", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh7/203_hires.png" },
  { id:"swsh7-209", name:"Glaceon",           variant:"VMAX", finish:"Alt Art",                   set:"Evolving Skies",              setId:"swsh7",     number:"209",  year:"2021", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh7/209_hires.png" },
  { id:"swsh7-205", name:"Leafeon",           variant:"VMAX", finish:"Alt Art",                   set:"Evolving Skies",              setId:"swsh7",     number:"205",  year:"2021", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh7/205_hires.png" },
  { id:"swsh7-208", name:"Espeon",            variant:"VMAX", finish:"Alt Art",                   set:"Evolving Skies",              setId:"swsh7",     number:"208",  year:"2021", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh7/208_hires.png" },
  { id:"swsh7-213", name:"Flareon",           variant:"VMAX", finish:"Alt Art",                   set:"Evolving Skies",              setId:"swsh7",     number:"213",  year:"2021", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh7/213_hires.png" },
  { id:"swsh7-211", name:"Jolteon",           variant:"VMAX", finish:"Alt Art",                   set:"Evolving Skies",              setId:"swsh7",     number:"211",  year:"2021", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh7/211_hires.png" },
  { id:"swsh7-207", name:"Vaporeon",          variant:"VMAX", finish:"Alt Art",                   set:"Evolving Skies",              setId:"swsh7",     number:"207",  year:"2021", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh7/207_hires.png" },
  { id:"swsh8-271", name:"Gengar",            variant:"VMAX", finish:"Alt Art",                   set:"Fusion Strike",               setId:"swsh8",     number:"271",  year:"2021", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh8/271_hires.png" },
  { id:"swsh8-269", name:"Mew",               variant:"VMAX", finish:null,                        set:"Fusion Strike",               setId:"swsh8",     number:"269",  year:"2021", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh8/269_hires.png" },
  { id:"swsh9-174", name:"Charizard",         variant:"VSTAR",finish:"Rainbow Rare",              set:"Brilliant Stars",             setId:"swsh9",     number:"174",  year:"2022", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh9/174_hires.png" },
  { id:"swsh9-176", name:"Arceus",            variant:"VSTAR",finish:null,                        set:"Brilliant Stars",             setId:"swsh9",     number:"176",  year:"2022", category:"pokemon", rarity:"Ultra Rare",                   image:"https://images.pokemontcg.io/swsh9/176_hires.png" },
  { id:"swsh9-186", name:"Lumineon",          variant:"V",    finish:"Alt Art",                   set:"Brilliant Stars",             setId:"swsh9",     number:"186",  year:"2022", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh9/186_hires.png" },
  { id:"swsh10-209",name:"Origin Forme Palkia",variant:"VSTAR",finish:"Alt Art",                  set:"Astral Radiance",             setId:"swsh10",    number:"209",  year:"2022", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh10/209_hires.png" },
  { id:"swsh10-214",name:"Hisuian Zoroark",   variant:"VSTAR",finish:"Alt Art",                   set:"Astral Radiance",             setId:"swsh10",    number:"214",  year:"2022", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh10/214_hires.png" },
  { id:"swsh11-214",name:"Giratina",          variant:"VSTAR",finish:"Alt Art",                   set:"Lost Origin",                 setId:"swsh11",    number:"214",  year:"2022", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh11/214_hires.png" },
  { id:"swsh11-213",name:"Aerodactyl",        variant:"VSTAR",finish:null,                        set:"Lost Origin",                 setId:"swsh11",    number:"213",  year:"2022", category:"pokemon", rarity:"Ultra Rare",                   image:"https://images.pokemontcg.io/swsh11/213_hires.png" },
  { id:"swsh12-211",name:"Lugia",             variant:"VSTAR",finish:"Special Art",               set:"Silver Tempest",              setId:"swsh12",    number:"211",  year:"2022", category:"pokemon", rarity:"Secret Rare",                  image:"https://images.pokemontcg.io/swsh12/211_hires.png" },
  { id:"swsh12-195",name:"Regidrago",         variant:"VSTAR",finish:null,                        set:"Silver Tempest",              setId:"swsh12",    number:"195",  year:"2022", category:"pokemon", rarity:"Ultra Rare",                   image:"https://images.pokemontcg.io/swsh12/195_hires.png" },
  { id:"swsh12pt5-160",name:"Pikachu",        variant:"VMAX", finish:null,                        set:"Crown Zenith",                setId:"swsh12pt5", number:"160",  year:"2023", category:"pokemon", rarity:"Ultra Rare",                   image:"https://images.pokemontcg.io/swsh12pt5/160_hires.png" },
  // ── Scarlet & Violet ────────────────────────────────────────────────
  { id:"sv1-227",   name:"Miraidon",          variant:"ex",   finish:null,                        set:"Scarlet & Violet",            setId:"sv1",       number:"227",  year:"2023", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv1/227_hires.png" },
  { id:"sv1-247",   name:"Koraidon",          variant:"ex",   finish:null,                        set:"Scarlet & Violet",            setId:"sv1",       number:"247",  year:"2023", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv1/247_hires.png" },
  { id:"sv3-228",   name:"Charizard",         variant:"ex",   finish:"Special Illustration Rare", set:"Obsidian Flames",             setId:"sv3",       number:"228",  year:"2023", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv3/228_hires.png" },
  { id:"sv3-225",   name:"Tyranitar",         variant:"ex",   finish:"Special Illustration Rare", set:"Obsidian Flames",             setId:"sv3",       number:"225",  year:"2023", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv3/225_hires.png" },
  // ── 151 ──────────────────────────────────────────────────────────────
  { id:"sv3pt5-199",name:"Charizard",         variant:"ex",   finish:"Special Illustration Rare", set:"Scarlet & Violet 151",        setId:"sv3pt5",    number:"199",  year:"2023", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv3pt5/199_hires.png" },
  { id:"sv3pt5-205",name:"Mew",               variant:"ex",   finish:"Special Illustration Rare", set:"Scarlet & Violet 151",        setId:"sv3pt5",    number:"205",  year:"2023", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv3pt5/205_hires.png" },
  { id:"sv3pt5-203",name:"Gengar",            variant:"ex",   finish:"Special Illustration Rare", set:"Scarlet & Violet 151",        setId:"sv3pt5",    number:"203",  year:"2023", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv3pt5/203_hires.png" },
  { id:"sv3pt5-200",name:"Alakazam",          variant:"ex",   finish:"Special Illustration Rare", set:"Scarlet & Violet 151",        setId:"sv3pt5",    number:"200",  year:"2023", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv3pt5/200_hires.png" },
  { id:"sv3pt5-197",name:"Blastoise",         variant:"ex",   finish:"Special Illustration Rare", set:"Scarlet & Violet 151",        setId:"sv3pt5",    number:"197",  year:"2023", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv3pt5/197_hires.png" },
  { id:"sv3pt5-198",name:"Venusaur",          variant:"ex",   finish:"Special Illustration Rare", set:"Scarlet & Violet 151",        setId:"sv3pt5",    number:"198",  year:"2023", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv3pt5/198_hires.png" },
  // ── Paradox Rift → Stellar Crown ─────────────────────────────────────
  { id:"sv4-245",   name:"Iron Valiant",      variant:"ex",   finish:"Special Illustration Rare", set:"Paradox Rift",                setId:"sv4",       number:"245",  year:"2023", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv4/245_hires.png" },
  { id:"sv4-235",   name:"Roaring Moon",      variant:"ex",   finish:"Special Illustration Rare", set:"Paradox Rift",                setId:"sv4",       number:"235",  year:"2023", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv4/235_hires.png" },
  { id:"sv5-206",   name:"Walking Wake",      variant:"ex",   finish:"Special Illustration Rare", set:"Temporal Forces",             setId:"sv5",       number:"206",  year:"2024", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv5/206_hires.png" },
  { id:"sv5-207",   name:"Iron Leaves",       variant:"ex",   finish:"Special Illustration Rare", set:"Temporal Forces",             setId:"sv5",       number:"207",  year:"2024", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv5/207_hires.png" },
  { id:"sv6-206",   name:"Ogerpon",           variant:"ex",   finish:"Special Illustration Rare", set:"Twilight Masquerade",         setId:"sv6",       number:"206",  year:"2024", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv6/206_hires.png" },
  { id:"sv6-207",   name:"Teal Mask Ogerpon", variant:"ex",   finish:"Special Illustration Rare", set:"Twilight Masquerade",         setId:"sv6",       number:"207",  year:"2024", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv6/207_hires.png" },
  { id:"sv7-168",   name:"Terapagos",         variant:"ex",   finish:"Special Illustration Rare", set:"Stellar Crown",               setId:"sv7",       number:"168",  year:"2024", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv7/168_hires.png" },
  { id:"sv7-170",   name:"Dragapult",         variant:"ex",   finish:"Special Illustration Rare", set:"Stellar Crown",               setId:"sv7",       number:"170",  year:"2024", category:"pokemon", rarity:"Special Illustration Rare",    image:"https://images.pokemontcg.io/sv7/170_hires.png" },
];
...
function cardImageUrl(card) { return card.image || `https://images.pokemontcg.io/${card.setId}/${card.number}_hires.png`; }
...
const SEALED_IMAGE_MAP = {
  "Evolving Skies Booster Box": "https://images.pokemontcg.io/swsh7/logo_hires.png",
  "Champion's Path Elite Trainer Box": "https://images.pokemontcg.io/cpa/logo_hires.png",
  "151 Booster Box": "https://images.pokemontcg.io/sv3pt5/logo_hires.png",
  "Vivid Voltage Booster Box": "https://images.pokemontcg.io/swsh4/logo_hires.png",
  "Brilliant Stars Booster Box": "https://images.pokemontcg.io/swsh9/logo_hires.png",
  "Lost Origin Booster Box": "https://images.pokemontcg.io/swsh11/logo_hires.png",
  "Silver Tempest Booster Box": "https://images.pokemontcg.io/swsh12/logo_hires.png",
};
...
export default function HoloHQApp() {
  ...
  const [portfolioViewMode, setPortfolioViewMode] = useState("grid"); // "list" | "grid"
  const [portfolioDetailSort, setPortfolioDetailSort] = useState("valueHigh"); // "name"|"priceHigh"|"priceLow"|"profit"|"trend"
  ...
  const handleGoogleAuth = async () => {
    setAuthLoading(true); setAuthError("");
    const { error } = await (supabase?.auth.signInWithOAuth({ provider: "google", options: { redirectTo: window.location.origin } }) ?? Promise.resolve({ error: { message: "Supabase not configured" } }));
  ...
  return (
    <div className="ht-root" data-mode={colorMode} style={{ minHeight: "100vh", width: "100%", position: "relative", overflowX: "hidden", paddingBottom: 74 }}>
        ...
        <div className="ht-fade pb-2" style={{ position: "relative" }}>
          ...
          <div className="px-4 mb-3 mt-1">
            <div className="ht-card p-3">
              {/* header */}
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-semibold" style={{ color:"var(--muted)", letterSpacing:"0.06em" }}>EBAY · {activeCondition?.replace("Raw ","") || "NM"}</span>
                <div className="flex items-center gap-2">
                  {ebayLoading && <Loader2 size={12} color="var(--cyan)" style={{ animation:"spin 1s linear infinite" }} />}
                  {!ebayLoading && ebayData && <button onClick={() => fetchEbayPrice(r.name, r.set, activeCondition, r.category)} style={{ color:"var(--muted)", fontSize:11 }}><RefreshCw size={11} /></button>}
                </div>
              </div>
      ...
      {/* ============ AUTH PAGE ============ */}
      {authOpen && (
        <div className="ht-fade" style={{ position:"fixed", inset:0, zIndex:70, background:"var(--void)", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:24, overflowY:"auto" }}>
          {/* logo */}
          <div className="text-center mb-8">
            <div className="ht-display" style={{ fontSize:48, background:"linear-gradient(90deg, var(--purple), var(--cyan))", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>HOLOHQ</div>
            <p className="text-sm mt-1" style={{ color:"var(--muted)" }}>Your card business, all in one place</p>
          </div>

          <div style={{ width:"100%", maxWidth:420 }}>
            {/* tab toggle */}
            <div className="flex rounded-xl p-1 mb-5" style={{ background:"var(--panel-2)" }}>
              <button onClick={() => { setAuthMode("login"); setAuthError(""); }} className="flex-1 rounded-lg py-2.5 text-sm font-semibold"
                style={{ background: authMode==="login" ? "var(--purple)" : "transparent", color: authMode==="login" ? "#fff" : "var(--muted)" }}>
                Sign In
              </button>
              <button onClick={() => { setAuthMode("signup"); setAuthError(""); }} className="flex-1 rounded-lg py-2.5 text-sm font-semibold"
            ...
            <div className="ht-card p-6 mb-4">
              ...
              {/* Google button */}
              <button disabled={authLoading} onClick={handleGoogleAuth}
                className="w-full rounded-xl py-3 text-sm font-semibold mb-4 flex items-center justify-center gap-3"
              ...
              <input value={authPass} onChange={e => setAuthPass(e.target.value)}
                placeholder={authMode==="signup" ? "Choose a strong password" : "Your password"} type="password"
                className="ht-input rounded-lg px-3 py-3 text-sm w-full mb-4"
            ...
            <button onClick={() => { setAuthOpen(false); setAuthError(""); }} className="text-xs w-full text-center py-2" style={{ color:"var(--muted)" }}>
